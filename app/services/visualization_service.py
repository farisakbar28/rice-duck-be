    ...
    def generate(self, payload: DSSSimulationRequest) -> VisualizationResponse:
        ...
        return VisualizationResponse(
            ...
            yield_series=YieldVisualization(
                ...
                yield_ref_kg_per_are=simulation.crop_yield.yield_ref_kg_per_are,
                yield_low_kg_per_are=simulation.crop_yield.yield_low_kg_per_are,
                yield_high_kg_per_are=simulation.crop_yield.yield_high_kg_per_are,
                yield_range_type=simulation.crop_yield.yield_range_type,
                yield_evidence_strength=simulation.crop_yield.yield_evidence_strength,
                yield_evidence_warning=simulation.crop_yield.yield_evidence_warning,
            ),
