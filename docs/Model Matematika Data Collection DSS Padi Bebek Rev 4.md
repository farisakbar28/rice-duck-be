...
**DSS Yield Prediction Padi-Bebek - Revisi 4**

Catatan Revisi 4:

- Scope aktif varietas padi tetap hanya Sertani/Seratih dan Inpari berdasarkan data collection lokal. Varietas lain tetap menjadi limitation/pengembangan lanjutan, bukan lookup aktif DSS Rev 4.
- Scope aktif sistem tanam tetap hanya Jajar Legowo/Jarwo dan Tegel/Konvensional berdasarkan data collection lokal. SRI, double transplant, dan sistem lain tetap menjadi limitation/pengembangan lanjutan.
- Umur bebek (U_bebek) diperkuat sebagai variabel aktif untuk harga beli bebek, status kesiapan umur, batas durasi maksimum, tanggal tarik, dan kualitas rekomendasi/confidence output.
- Pengaruh umur bebek terhadap Laba_bersih dan DeltaProfit hanya masuk melalui harga beli bebek (p_duck_buy_age). Pengaruh lain seperti pakan, bobot, survival, kotoran, dan perilaku bebek tidak dimasukkan ke profit sebelum tersedia data lokal yang lebih kuat.
- Harga beli bebek memakai input aktual saat tersedia. Pada kondisi tidak tersedia, range lokal Rp25.000-Rp28.000/ekor untuk bebek umur sekitar 2-3 minggu digunakan sebagai fallback awal; di luar rentang umur tersebut sistem meminta harga actual/membut optional input user yang hanya muncul ketika di luar rentang umur tersebut.
- Status umur bebek dibuat sederhana: belum disarankan, muda/perlu pengawasan, siap lokal, dan lebih tua/perlu durasi konservatif.
- Durasi maksimum rekomendasi kini dibatasi oleh tiga hal: fase padi, daya guna lokal durasi bebek, dan umur bebek saat masuk sawah.
- Target umur tarik konservatif ditetapkan 60 hari sebagai guard awal. Nilai ini tidak diklaim sebagai angka biologis universal; fungsinya menjaga rekomendasi tidak terlalu lama ketika bebek masuk dalam umur lebih tua.
- q_feed fallback operasional tetap 0,10 kg/ekor/hari dan tidak diubah oleh umur bebek pada Rev 4. Variasi kebutuhan pakan menurut umur menjadi limitation sampai data pakan lokal per umur tersedia.
- Emisi/lingkungan tetap menjadi limitation penelitian dan tidak menjadi komponen aktif perhitungan DSS Rev 4.

Label status tetap dipakai untuk membedakan data lokal, estimasi lokal, dan rumus referensi yang belum dikalibrasi lokal oleh Astungkara Way.
...
- Revisi 4 menetapkan modul emisi/lingkungan (CO2e, GHGI, Reduksi_CH4, dan relasi DO-to-CH4) tidak menjadi komponen aktif perhitungan DSS karena data CH4, N2O, baseline emisi konvensional, dan DO tidak tersedia dari mitra. Bagian tersebut dicatat sebagai limitation penelitian, bukan output numerik sistem.

| **Keputusan**                         | **Isi keputusan**                                                                                                                                                       | **Dampak ke DSS/paper**                                                                                                               |
|---------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------|
...
| Emisi menjadi limitation penelitian   | CO2e/GHGI/Reduksi_CH4/DO-to-CH4 tidak menjadi komponen aktif perhitungan DSS Rev 4 karena data CH4, N2O, baseline emisi konvensional, dan DO tidak tersedia dari mitra. | Mencegah overclaim; emisi hanya dijelaskan sebagai keterbatasan dan peluang riset lanjutan.                                           |
| Umur bebek aktif sebagai quality gate | U_bebek dipakai untuk membaca kesiapan umur, harga beli, batas durasi maksimum, tanggal tarik, dan confidence output.                                                   | Rekomendasi lebih realistis tanpa mengubah langsung yield, pakan, survival, kotoran, dan profit selain lewat harga beli.              |
| Profit tetap konservatif              | Laba_bersih dan DeltaProfit hanya menerima pengaruh umur bebek melalui p_duck_buy_age.                                                                                  | Menghindari overclaim karena data lokal belum cukup untuk memodelkan pengaruh umur terhadap pakan, bobot jual, survival, dan kotoran. |
...
| Formula-kept / belum terkalibrasi lokal | Rumus/data tetap dicantumkan dan dihitung hanya untuk komponen yang masih menjadi ruang lingkup DSS Rev 4. | C_feed referensi, N/P/K_tanah, V_eco1, V_eco2.                               | Tampilkan sebagai estimasi/catatan model dengan label belum dikalibrasi lokal oleh Astungkara Way, bukan angka lokal terkonfirmasi. |

# 3. Data Collection: Parameter Lokal dan Referensi

| **Parameter**               | **Nilai / range**                                                                       | **Satuan**      | **Sumber**                                            | **Status**                          | **Catatan pemakaian**                                                                                                                                                                                                   |
|-----------------------------|-----------------------------------------------------------------------------------------|-----------------|-------------------------------------------------------|-------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| V                           | Sertani/Seratih; Inpari                                                                 | kategori        | Data collection lokal                                 | Local-estimate lookup               | Scope aktif DSS Rev 4 hanya dua kelompok varietas yang paling kuat muncul pada data collection lokal. Varietas lain menjadi limitation/pengembangan lanjutan.                                                           |
| S                           | Jajar Legowo/Jarwo; Tegel/Konvensional                                                  | kategori        | Data collection lokal                                 | Local-estimate lookup               | Scope aktif DSS Rev 4 hanya dua sistem tanam yang muncul pada praktik padi-bebek lokal. Sistem lain menjadi limitation/pengembangan lanjutan.                                                                           |
| TD                          | Runtime input                                                                           | tanggal         | Input petani                                          | Local-estimate                      | Jangkar kalender; tidak langsung masuk yield.                                                                                                                                                                           |
| U_bebek                     | 14-20 muda/perlu pengawasan; 21-30 siap lokal; \>30 lebih tua/perlu durasi konservatif  | hari            | Data collection                                       | Local-estimate                      | Dipakai untuk status umur, harga beli bebek, batas durasi maksimum, tanggal tarik, dan confidence output. Tidak langsung mengubah yield, pakan, survival, kotoran, atau manfaat ekologis.                               |
...
| lambda                      | 0.35-0.67; default awal 0.67 pada kondisi tidak ada data pasti                          | rasio 0-1       | Data collection                                       | Local-estimate                      | 0.67 adalah estimasi atas, bukan rata-rata tetap.                                                                                                                                                                       |
...
| p_gabah_RD                  | Belum dikonfirmasi; dapat sama atau premium dengan data pendukung                       | Rp/kg           | Data collection                                       | Parsial                             | Jangan klaim premium pada kondisi harga lokal belum dikunci/didapatkan.                                                                                                                                                 |
| rendemen gabah-beras        | sekitar 50%; range 46-60                                                                | persen          | Data collection                                       | Local-estimate                      | Khusus perspektif beras.                                                                                                                                                                                                |
| p_duck_buy                  | Rp25.000-Rp28.000/ekor untuk umur sekitar 2-3 minggu; input aktual lebih diprioritaskan | Rp/ekor         | Data collection                                       | Local-estimate                      | Umur pembelian wajib dicatat bersama harga. Pada Rev 4, pengaruh umur terhadap profit hanya masuk melalui p_duck_buy_age.                                                                                               |
...
| p_feed                      | Input/parameter lokal; belum default tetap                                              | Rp/kg           | Data collection                                       | Parsial                             | Dipakai untuk C_feed. Harga pakan lokal belum dikonfirmasi: gunakan nilai referensi/estimasi dengan status sumber data yang eksplisit.                                                                                  |
...
| U_status                    | Belum disarankan; muda/perlu pengawasan; siap lokal; lebih tua/perlu durasi konservatif | kategori        | Data collection + referensi bebek muda                | Local-estimate + reference context  | Menjelaskan kesiapan umur bebek tanpa menjadikan umur sebagai pengubah langsung semua rumus.                                                                                                                            |
| U_target_out_max            | 60                                                                                      | hari umur bebek | Data collection + referensi sistem rice-duck-crayfish | Reference-context guard             | Guard konservatif untuk membatasi durasi saat bebek masuk lebih tua. Bukan angka biologis universal; perlu validasi lokal.                                                                                              |
| t_age_max                   | max(0, min(t_lokal_max, U_target_out_max - U_bebek))                                    | hari            | Turunan U_bebek dan guard umur                        | System-design berbasis konteks umur | Batas durasi maksimum dari sisi umur bebek. Dipakai bersama batas fase padi.                                                                                                                                            |
| p_duck_buy_age              | Input aktual; fallback Rp25.000-Rp28.000/ekor untuk umur sekitar 2-3 minggu             | Rp/ekor         | Data collection lokal                                 | Local-estimate                      | Harga beli yang dipakai dalam C_duck_buy. Di luar umur 14-30 hari, sistem meminta input harga aktual.                                                                                                                   |
| Q_output                    | High / Medium / Low berdasarkan kelengkapan area, kalender, umur, harga, dan baseline   | kategori        | Aturan model Rev 4                                    | System-design                       | Membaca kualitas rekomendasi tanpa mengklaim akurasi terkonfirmasi sebelum validasi panen lokal.                                                                                                                        |
...
| V_duck_Xiong      | \[-0.0096*d_lit_ha^2 + (11.3861 + 14.4*lambda)*d_lit_ha - 0.18*lambda*t*d_lit_ha + 17.0857\] \* A_ha_note  | Model nilai bebek dari referensi padi-bebek.                                                                                                                 | Koefisien ekonomi bukan rupiah/Bali; jangan dipakai sebagai profit lokal terverifikasi. d_lit_ha dan A_ha_note hanya catatan rumus literatur.                                                         |
...
Untuk DSS Rev 4, f_yield hanya dipakai pada sistem aktif: Tegel/Konvensional dan Jajar Legowo/Jarwo. Nilai dari SRI, double transplant, dan sistem lain tidak menjadi lookup aktif karena tidak muncul kuat pada data collection lokal dan tidak masuk scope DSS saat ini.

\[local-calculated\] tanggal_lepas = TD + HST_masuk

Output jadwal ke petani.

\[local-calculated\] tanggal_tarik = TD + HST_masuk + t, dengan t \<= min(t_max_eff, HST_heading - HST_masuk, t_age_max). Bebek tetap ditarik sebelum risiko keluar malai dan sebelum batas umur konservatif terlewati.

Bebek tidak boleh melewati fase keluar malai.

5.2A Integrasi Umur Bebek dalam Rekomendasi Rev 4

\[local-estimate\] U_bebek = umur bebek saat masuk sawah, dalam hari.

U_bebek tidak dipakai untuk mengubah langsung yield, survival, pakan, kotoran, N/P/K, atau manfaat ekologis. Pada Rev 4, umur bebek dipakai untuk membaca kesiapan umur, harga beli bebek, durasi maksimum, tanggal tarik, dan kualitas rekomendasi.

\[local-estimate\] U_status = lookup(U_bebek). Kategori yang digunakan: U_bebek \< 14 hari = belum disarankan; 14 \<= U_bebek \< 21 hari = muda/perlu pengawasan; 21 \<= U_bebek \<= 30 hari = siap lokal; U_bebek \> 30 hari = lebih tua/perlu durasi konservatif.

\[reference-context guard\] U_target_out_max = 60 hari. Nilai ini dipakai sebagai guard awal karena data lokal menunjukkan umur 21-30 hari lebih aman untuk masuk sawah, sedangkan referensi rice-duck-crayfish menggunakan bebek umur 20 hari dengan masa simbiosis 40 hari. Guard ini belum menjadi angka lokal terkonfirmasi.

\[system-design\] t_age_max = max(0, min(t_lokal_max, U_target_out_max - U_bebek))

\[system-design\] t_maks_rekomendasi = min(t_max_eff, HST_heading - HST_masuk, t_age_max)

\[local-calculated\] tanggal_tarik_rekomendasi = TD + HST_masuk + t_rekomendasi, dengan t_rekomendasi \<= t_maks_rekomendasi.

\[local-estimate\] p_duck_buy_age = p_duck_buy_input pada kondisi harga aktual tersedia. Pada kondisi belum tersedia dan U_bebek berada pada sekitar 14-30 hari, sistem dapat memakai range lokal Rp25.000-Rp28.000/ekor atau nilai tengah Rp26.500/ekor sebagai fallback awal. Di luar rentang tersebut, harga aktual wajib diminta melalui optional input user yang hanya muncul Ketika umur bebek di luar rentang tersebut agar profit tidak bias.

\[local-calculated\] C_duck_buy = J \* p_duck_buy_age. Pengaruh umur bebek terhadap Laba_bersih dan DeltaProfit hanya masuk melalui C_duck_buy.

\[system-design\] C_age = 0,40 untuk U_bebek \< 14; 0,70 untuk 14 \<= U_bebek \< 21; 1,00 untuk 21 \<= U_bebek \<= 30; 0,75 untuk U_bebek \> 30. Nilai ini hanya membaca kualitas input umur, bukan probabilitas biologis.

\[system-design\] Q_output = min(C_area, C_calendar, C_age, C_price, C_baseline). Q_output ditampilkan sebagai High, Medium, atau Low agar pengguna memahami seberapa kuat rekomendasi dapat dipercaya berdasarkan kelengkapan data.

## 5.3 Durasi, Survival, dan Kotoran

\[system-design\] 0 \< t \<= min(t_max_eff, HST_heading - HST_masuk, t_age_max)
...
\[local-estimate\] C_duck_buy = J \* p_duck_buy_age

Biaya pembelian bibit/anak bebek.

\[mixed\] C_feed = J \* q_feed \* t_effective \* p_feed \* (1 - kappa_feed_save). Pada Rev 4, q_feed tidak diubah oleh U_bebek karena data pakan lokal per umur belum tersedia. Pengaruh umur terhadap pakan dicatat sebagai limitation.
...
\[mixed\] Laba_bersih = R_gabah_RD + V_duck_lokal + V_eco - C_infra - biaya_tambahan_lain. Pada Rev 4, pengaruh U_bebek ke Laba_bersih hanya melalui p_duck_buy_age di dalam C_duck_buy.
...
Modul emisi/lingkungan tidak menjadi komponen aktif perhitungan DSS Rev 4.
...
Rumus berikut hanya disimpan sebagai konteks riset lanjutan, tidak dipakai dalam objective function dan tidak ditampilkan sebagai output utama DSS Rev 4:
...
\[system-design\] Score_environment = tidak digunakan pada DSS Rev 4
...
Mode aktif Rev 4 saat data ekonomi belum lengkap:
...
\[system-design\] Q_output tidak menjadi pengganti objective function. Nilai ini hanya menerangkan kualitas rekomendasi berdasarkan data pendukung: area aktif, kalender padi, umur bebek, harga beli bebek, dan baseline yield.

# 6. Kamus Variabel Aktif DSS Rev 4

Catatan Rev 4: kamus ini hanya memuat variabel yang menjadi bagian aktif DSS. Variabel emisi dan variabel kondisi operasional non-daily-duck tidak dimasukkan ke kamus aktif karena menjadi limitation penelitian.

| **No** | **Variabel**                | **Kelompok**                | **Makna**                                                            | **Satuan**                          | **Status**                                       |
|--------|-----------------------------|-----------------------------|----------------------------------------------------------------------|-------------------------------------|--------------------------------------------------|
...
| 34     | f_yield                     | Lookup agronomi             | Faktor pengali yield untuk sistem tanam aktif Rev 4                  | rasio                               | Literature-uncalibrated; hanya Jarwo/Tegel aktif |
...
| 60     | U_status                    | Input/quality gate          | Status kesiapan umur bebek saat masuk sawah                          | kategori                            | Local-estimate + reference-context               |
| 61     | p_duck_buy_age              | Parameter biaya             | Harga beli bebek yang mempertimbangkan umur pembelian                | Rp/ekor                             | Local-estimate/input                             |
| 62     | U_target_out_max            | Constraint umur             | Batas umur tarik konservatif untuk menjaga durasi tidak terlalu lama | hari umur bebek                     | Reference-context guard                          |
| 63     | t_age_max                   | Constraint umur             | Durasi maksimum dari sisi umur bebek                                 | hari                                | Calculated/system-design                         |
| 64     | t_maks_rekomendasi          | Constraint rekomendasi      | Durasi maksimum gabungan dari fase padi, batas model, dan umur bebek | hari                                | Calculated                                       |
| 65     | Q_output                    | Output kualitas rekomendasi | Kualitas/confidence rekomendasi berdasarkan kelengkapan data kunci   | High/Medium/Low                     | System-design                                    |

# 7. Limitation Penelitian dan Variabel Non-Aktif

Bagian ini memuat data, variabel, atau komponen yang ditemukan pada data collection/literatur, tetapi tidak menjadi scope aktif DSS Rev 4. Komponen ini tidak dipakai dalam perhitungan, lookup aktif, objective function, maupun output numerik utama.

| **Komponen non-aktif**                                                                                                  | **Status Rev 4**                         | **Alasan**                                                                                                                                                                                                                                                |
|-------------------------------------------------------------------------------------------------------------------------|------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Varietas tambahan seperti Cigelis/Cegelis, Ciherang, beras merah, dan lainnya                                           | Limitation / pengembangan lanjutan       | Data collection lokal paling kuat hanya menyebut Sertani/Seratih dan Inpari sebagai varietas utama. Varietas lain tidak dipakai sebagai lookup aktif agar tidak overclaim.                                                                                |
| Sistem tanam tambahan seperti SRI, double transplant, dan lainnya                                                       | Limitation / pengembangan lanjutan       | Data collection lokal untuk praktik padi-bebek hanya memuat Jajar Legowo/Jarwo dan Tegel/Konvensional. Sistem lain tidak dipakai sebagai lookup aktif DSS Rev 4.                                                                                          |
...
| daily_labor_hours                                                                                                       | Limitation penelitian                    | Jam kerja pengelolaan belum menjadi rumus biaya/produktivitas terukur pada DSS Rev 4. Tidak dipakai dalam profit atau objective.                                                                                                                          |
...
| kappa_feed_greedy dan Penalty_feed                                                                                      | Non-aktif pada model Rev 4               | Data fase pakan tambahan tinggi masih bersifat kualitatif. Biaya pakan aktif cukup memakai C_feed dengan q_feed fallback 0.10 dan p_feed ketika tersedia.                                                                                                 |
...
| Data panen lokal bersih per petak aktif                                                                                 | Kebutuhan kalibrasi lanjutan             | Data panen padi-bebek sering tercampur antara petak bebek dan non-bebek, sehingga belum cukup sebagai kalibrasi alpha_local.                                                                                                                              |
| Harga gabah/beras padi-bebek dan harga pakan lokal Rp/kg                                                                | Kebutuhan kalibrasi lanjutan             | Sebagian harga tersedia secara parsial, tetapi belum cukup untuk membuat seluruh output profit numeric-ready pada semua skenario.                                                                                                                         |
...
| Pengaruh umur bebek terhadap pakan, bobot jual, survival, kotoran, dan perilaku di sawah                                | Limitation penelitian Rev 4              | Umur bebek sudah dipakai untuk harga beli, status umur, durasi maksimum, tanggal tarik, dan confidence output. Namun data lokal belum cukup untuk mengubah langsung C_feed, N_d, Dung_total, N/P/K_tanah, V_eco, yield, atau bobot jual berdasarkan umur. |
...
| Pakan                | feed_kg_total, feed_cost_total                                                               | kg/Rp                    | Prioritas tinggire            | Kalibrasi q_feed lokal dan biaya pakan. Jenis pakan tidak menjadi variabel model utama. C_feed tetap aktif memakai fallback q_feed 0.10 sampai data lokal tersedia. |
...
| Umur dan harga bebek | U_bebek_days, U_status_lapangan, p_duck_buy, purchase_date, duck_size_note, duck_health_note | hari/kategori/Rp/catatan | Wajib untuk Rev 4             | Mengkalibrasi hubungan umur bebek dengan harga beli, status kesiapan, durasi maksimum, dan confidence output.                                                       |
| Pakan per umur       | feed_kg_total_by_age, feed_cost_total_by_age, feed_type_note                                 | kg/Rp/catatan            | Pengembangan lanjutan         | Saat ini tidak mengubah C_feed berdasarkan umur; data ini dikumpulkan untuk validasi lanjutan.                                                                      |
...
| R-10 Emisi          | CO2e/GHGI/Reduksi_CH4/DO-to-CH4 tidak menjadi output numerik DSS Rev 4 dan tidak masuk objective.                                                                                       | Data CH4, N2O, baseline emisi konvensional, dan DO tidak tersedia dari mitra; bagian ini menjadi limitation penelitian. |
...
| R-14 Umur bebek     | U_bebek dipakai untuk p_duck_buy_age, U_status, t_age_max, tanggal_tarik, dan Q_output. Laba_bersih dan DeltaProfit hanya terdampak melalui p_duck_buy_age.                             | Sesuai keputusan Rev 4: pengaruh lain dari umur bebek tetap limitation sampai tersedia data lokal per umur.             |
...
| A-09 Nilai ekonomi bebek aktual             | C_duck_buy = J\*p_duck_buy_age; C_feed = J\*q_feed\*t_effective\*p_feed\*(1-kappa_feed_save); V_duck_lokal = N_d_aktual\*p_duck - C_duck_buy - C_feed; V_duck_Xiong = \[-0.0096d_lit_ha^2 + (11.3861+14.4lambda)d_lit_ha - 0.18lambda\*t_aktual\*d_lit_ha + 17.0857\]\*A_ha_note | Estimasi nilai ekonomi bebek lokal dan nilai referensi Xiong.                             | Membedakan ekonomi bebek berbasis harga lokal dari model referensi. Pada Rev 4, umur bebek memengaruhi ekonomi hanya melalui p_duck_buy_age. C_feed tidak berubah berdasarkan umur sampai data pakan per umur tersedia. | V_duck_lokal aktif estimasi local/reference-mixed; V_duck_Xiong literature-uncalibrated.                           |
...
| A-12 Emisi dan lingkungan aktual            | Tidak dihitung sebagai output numerik DSS Rev 4.                                                                                                                                                                                                                                 | Tidak ada CO2e, GHGI, Reduksi_CH4, atau DO-to-CH4 pada output utama.                      | Data CH4, N2O, baseline emisi konvensional, dan DO tidak tersedia dari mitra.                                                                                                                                           | Limitation penelitian; bukan komponen aktif DSS.                                                                   |
| A-13 Status umur dan confidence aktual      | U_status = lookup(U_bebek); t_age_max=max(0,min(t_lokal_max,U_target_out_max-U_bebek)); Q_output=min(C_area,C_calendar,C_age,C_price,C_baseline)                                                                                                                                 | Status umur bebek, batas durasi dari sisi umur, dan kualitas rekomendasi aktual.          | Menjelaskan apakah input umur bebek mendukung rekomendasi. Tidak mengubah profit kecuali melalui p_duck_buy_age.                                                                                                        | System-design + local-estimate; perlu validasi siklus lanjutan.                                                    |

## 10.2 Skenario Output Rekomendasi dan Status Klaim

| **Output DSS**                                | **Rumus perhitungan**                                                                                                                                                                                                                                                                                                                  | **Yang dihasilkan**                                                                                                  | **Penjelasan skenario**                                                                                                                                                               | **Status klaim**                                                                           |
|-----------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|
| R-01 Variabel keputusan rekomendasi           | (d_are, t) = argmax F_active(d,t), dengan 0 \< d_are \<= K_max_are dan 0 \< t \<= min(t_max_eff, HST_heading - HST_masuk, t_age_max)                                                                                                                                                                                                   | Kepadatan rekomendasi berbasis are dan durasi rekomendasi terbaik menurut DSS.                                       | Sistem mencari kombinasi kepadatan dan durasi terbaik berdasarkan objective aktif: yield + ecology - risk penalty; profit masuk jika numeric-ready; environment tidak masuk.          | System-design + literature baseline; nilai akhir perlu validasi lokal.                     |
...
| R-03 Timeline rekomendasi                     | tanggal_lepas_rekomendasi = TD + HST_masuk; tanggal_tarik_rekomendasi = TD + HST_masuk + t\*, dengan t\* \<= min(t_max_eff, HST_heading-HST_masuk, t_age_max)                                                                                                                                                                          | Tanggal lepas dan tanggal tarik bebek versi rekomendasi.                                                             | Memberikan jadwal rekomendasi yang mengikuti kalender padi, varietas, batas keluar malai, dan batas umur bebek.                                                                       | Local-estimate: lookup HST masih estimasi; local-calculated: TD dan lookup valid.          |
...
| R-06 Perbandingan yield rekomendasi vs aktual | DeltaYield = x_final_rec - x_final_aktual; DeltaYield\_% = DeltaYield/x_final_aktual\*100%                                                                                                                                                                                                                                             | Selisih yield absolut dan persentase terhadap skenario aktual.                                                       | Menunjukkan apakah rekomendasi memberi peningkatan hasil atau hanya memperbaiki risiko tanpa kenaikan besar.                                                                          | Calculated comparison; klaim peningkatan lokal menunggu validasi panen petak aktif.        |
...
| R-09 Nilai ekonomi bebek rekomendasi          | C_duck_buy_rec = J_rekomendasi\*p_duck_buy_age; C_feed_rec = J_rekomendasi\*q_feed\*t_effective_rec\*p_feed\*(1-kappa_feed_save); V_duck_lokal_rec = N_d_rec\*p_duck - C_duck_buy_rec - C_feed_rec; V_duck_Xiong_rec = \[-0.0096d_lit_ha_rec^2 + (11.3861+14.4lambda)d_lit_ha_rec - 0.18lambda\*t\*d_lit_ha_rec + 17.0857\]\*A_ha_note | Estimasi nilai bebek lokal dan referensi pada skenario rekomendasi.                                                  | Menghitung dampak jumlah bebek rekomendasi terhadap biaya beli, biaya pakan, survival, dan nilai jual bebek. Pada Rev 4, umur bebek hanya mengubah C_duck_buy melalui p_duck_buy_age. | V_duck_lokal aktif estimasi local/reference-mixed; V_duck_Xiong literature-uncalibrated.   |
...
| R-12 Emisi dan lingkungan rekomendasi         | Tidak dihitung sebagai output numerik DSS Rev 4.                                                                                                                                                                                                                                                                                       | Tidak ada CO2e, GHGI, DeltaGHGI, atau Reduksi_CH4 pada rekomendasi utama.                                            | Data CH4, N2O, baseline emisi konvensional, dan DO tidak tersedia dari mitra.                                                                                                         | Limitation penelitian; bukan komponen aktif DSS.                                           |
...
| R-14 Status umur dan kualitas rekomendasi     | U_status_rec = lookup(U_bebek); t_age_max=max(0,min(t_lokal_max,U_target_out_max-U_bebek)); t_rec \<= min(t_max_eff,HST_heading-HST_masuk,t_age_max); Q_output=min(C_area,C_calendar,C_age,C_price,C_baseline)                                                                                                                         | Status umur, batas durasi rekomendasi, tanggal tarik konservatif, dan confidence rekomendasi.                        | Rekomendasi lebih konservatif saat bebek masuk terlalu muda atau terlalu tua. Profit dan DeltaProfit hanya berubah melalui p_duck_buy_age.                                            | System-design + local-estimate; memerlukan validasi lapangan.                              |
...
| Limitation | CO2e/GHGI/Reduksi_CH4/DO-to-CH4 | Tidak dihitung sebagai output numerik DSS Rev 4                                 | Data CH4, N2O, baseline emisi konvensional, dan DO tidak tersedia dari mitra.                                                                           |
| Input      | U_bebek                         | 21-30 hari sebagai rentang siap lokal                                           | Umur masuk sawah yang lebih aman berdasarkan data collection lokal.                                                                                     |
| Umur       | U_status                        | Siap lokal                                                                      | Status umur mendukung rekomendasi.                                                                                                                      |
| Harga      | p_duck_buy_age                  | Rp25.000-Rp28.000/ekor; default ilustratif Rp26.500/ekor                        | Dipakai hanya untuk C_duck_buy, Laba_bersih, dan DeltaProfit.                                                                                           |
| Durasi     | t_age_max                       | min(40, 60 - U_bebek)                                                           | Guard umur: makin tua bebek saat masuk, makin pendek durasi maksimum yang disarankan.                                                                   |
| Confidence | Q_output                        | High/Medium/Low                                                                 | Membaca kualitas rekomendasi berdasarkan data area, kalender, umur, harga, dan baseline.                                                                |

12\. Ringkasan Integrasi Umur Bebek pada Rev 4

Revisi 4 menempatkan umur bebek sebagai variabel pendukung keputusan yang penting, tetapi tetap dibatasi agar tidak menimbulkan klaim biologis berlebihan. Umur bebek tidak menggantikan decision variable utama, yaitu kepadatan bebek dan durasi aktif di sawah. Umur bebek hanya membantu membaca apakah bebek cukup siap masuk sawah, berapa harga beli yang relevan, seberapa panjang durasi maksimum yang masih konservatif, kapan bebek sebaiknya ditarik, dan seberapa kuat kualitas rekomendasi yang diberikan.

Data Astungkara Way menunjukkan bahwa bebek umumnya masuk sawah pada umur 2-3 minggu, dengan umur 21-30 hari dianggap lebih aman karena bebek yang terlalu muda lebih rentan terhadap adaptasi. Data collection juga menunjukkan bahwa harga beli anak bebek berada pada kisaran Rp25.000-Rp28.000/ekor, dan umur pembelian perlu dicatat bersama harga. Dengan demikian, p_duck_buy_age menjadi parameter ekonomi utama yang menghubungkan umur bebek dengan Laba_bersih dan DeltaProfit.

Referensi tentang bebek muda pada sistem integrasi padi-bebek-crayfish menunjukkan penggunaan bebek umur 20 hari dengan durasi simbiosis 40 hari, sedangkan artikel nutrisi bebek menunjukkan bahwa fase 1-21 hari dan 29-49 hari memiliki karakter pertumbuhan dan pakan yang berbeda. Bukti ini digunakan sebagai konteks bahwa umur berpengaruh terhadap kesiapan dan manajemen, tetapi Rev 4 belum mengubah langsung pakan, survival, bobot jual, kotoran, atau output ekologis karena data lokal per umur belum tersedia.

Keputusan praktis Rev 4 adalah: umur bebek memengaruhi p_duck_buy_age, U_status, t_age_max, tanggal_tarik, dan Q_output. Selain harga beli, seluruh pengaruh umur terhadap profit, feed, bobot, survival, dan kotoran tetap menjadi limitation serta kebutuhan data collection lanjutan.
