# R2 Phase-6 Validation Report (OFFICIAL_FROZEN_EXECUTION)

> Execution: 2026-08-26T20:28:27+00:00 | Python 3.14.2 | backend commit `b10b0a1f83357c5db1d6cdfb9c41eaa84b6727a7` | registry `R2-2026-08-26.3` | freeze_id `R2-FREEZE-2026-08-26.5`

## 1. Freeze identity
- model_version=R2 (unchanged)
- parameter_registry_version=R2-2026-08-26.3 (unchanged)
- history schema=4; app_version=0.1.0
- MODEL_FROZEN=True, FREEZE_ID=R2-FREEZE-2026-08-26.5, FREEZE_EFFECTIVE_FROM=2026-08-26
...
- N=12; hits=4; coverage=0.3333333333333333
- mean_distance_to_window_days=5.0; median_distance_to_window_days=5.0
- timing_semantics=HST_FROM_FIELD_TRANSPLANTING; timing_semantics_status=VALIDATION_ASSUMPTION

## 7. Yield status
- status=NOT_EVALUABLE; reason=None
- blocker=NOT_EVALUABLE
- HTTP_EXECUTION_FAILURE_N=0; SCIENTIFIC_UNAVAILABLE_N=14

## 8. Revenue status
- CURRENT_HPP_OPERATIONAL_VALUE_DIAGNOSTIC: status=NOT_EVALUABLE; reason=NO_ELIGIBLE_PREDICTED_ROWS; N_actual_eligible=0; N_predicted=0; MAE Rp/cycle=None; RMSE Rp/cycle=None; MedAE Rp/cycle=None; MBE Rp/cycle=None; WAPE %=None; envelope_coverage=None
- PRICE_NEUTRAL_HISTORICAL_PRICE_DIAGNOSTIC: status=NOT_EVALUABLE; reason=HISTORICAL_PADDY_PRICE_UNAVAILABLE; N_actual_eligible=0; N_predicted=0; MAE Rp/cycle=None; RMSE Rp/cycle=None; MedAE Rp/cycle=None; MBE Rp/cycle=None; WAPE %=None; envelope_coverage=None
- Current HPP is an operational value benchmark, not observed historical farm revenue; historical price is comparator metadata only.
...
- strict_N=27; strict_excluded_N=9; provenance_counts={'OBSERVED_VALUE': 27, 'DERIVED_ACTUAL': 2, 'EXPLICIT_ZERO': 4, 'MISSING_UNKNOWN': 3, 'LEGACY_IMPUTATION': 0}; derived_actual_context_N=2
- deterministic identity verified by V1 tests; observed historical prices are plausibility/comparator context; strict observed positive rows only.
