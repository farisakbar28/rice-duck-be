...
def test_v3_history_round_trip_and_delete() -> None:
    ...
    payload = {"land_area_are": 10, "duck_count": 20, "rice_variety": "inpari", "planting_system": "jajar_legowo", "duck_age_days": 21, "planting_date": "2026-01-01", "p_duck_buy": 15000}
    ...
    assert (detail.json()["harvest_hst_min"], detail.json()["harvest_hst_max"]) == (109, 116)
